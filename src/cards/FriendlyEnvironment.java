...
static private final String cardName = "FriendlyEnvironment";
    ...
    private class FriendlyEnvironmentEnchantment extends AbstractEnchantment {
        ...
        private final TriggerAction GreetingAction = new TriggerAction() {
                ...
                public void execute(Object args) {
                    if (args != null  && args instanceof Creature) {
                        ...
                        System.out.println( getName() + " says: \"Welcome " + c.getName()+"!\"" );
                    }
                }
            };
        ...
        @Override
        public String getName() { return "Friendly Environment"; }
    }
    ...
    @Override
    public String ruleText() { return "Whenever a creature enters the game " + getName() + " welcomes it"; }
    @Override
    public String toString() { return getName() + " (" + type() + ") [" + ruleText() +"]";}
    @Override
